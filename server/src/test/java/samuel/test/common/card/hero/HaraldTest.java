...
import samuel.card.hero.HaraldHeroCard;
...
public class HaraldTest {
    ...
    void testCorrectResources() {
        assertEquals(createBundle(GrainResource.class, OreResource.class), hero.getCost());
    }
