...
public class GoldShipTest {
    ...
    void testFunctionality() {
        ...
        board.place(ship, board.getPositionFromGrid(1,1));
        ship.onPlace(player, context, board.getPositionFromGrid(1,1));
        PlayerTradeEvent event = new PlayerTradeEvent(player, new ResourceAmount(toTrade, 3), new ResourceAmount(LumberResource.class, 1));
    ...
    void testWrongResource() {
        ...
        board.place(ship, board.getPositionFromGrid(1,1));
        ship.onPlace(player, context, board.getPositionFromGrid(1,1));
        PlayerTradeEvent event = new PlayerTradeEvent(player, new ResourceAmount(LumberResource.class, 3), new ResourceAmount(LumberResource.class, 1));
        eventBus.fireEvent(event);
