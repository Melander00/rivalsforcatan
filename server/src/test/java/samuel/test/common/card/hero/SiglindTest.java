...
import samuel.card.hero.SiglindHeroCard;
...
public class SiglindTest {
    ...
    void testCorrectResources() {
        assertEquals(createBundle(
                GrainResource.class, WoolResource.class, WoolResource.class, OreResource.class
        ), hero.getCost());
    }
