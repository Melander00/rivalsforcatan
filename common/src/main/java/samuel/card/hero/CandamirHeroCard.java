...
public class CandamirHeroCard implements HeroCard {
    private static final CardID id = new CardID("hero", "candamir");
    ...
    public PointBundle getPoints() {
        ...
        bundle.addPoint(StrengthPoint.class, 4);
        bundle.addPoint(SkillPoint.class, 1);
        return bundle;
    }
    ...
    public ResourceBundle getCost() {
        ...
        bundle.addResource(WoolResource.class, 2);
